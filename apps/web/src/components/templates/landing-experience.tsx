...
export function LandingExperience({
  ...
  return (
    <main className="min-h-screen bg-[#eef3ff] text-[#07164b]">
      ...
      <section
        className="mx-auto grid min-h-[82svh] w-full max-w-7xl items-center gap-14 px-5 pb-20 pt-32 sm:px-8 lg:grid-cols-[0.95fr_1.05fr]"
        id="contacto"
      >
        <div>
          ...
          <h1 className="mt-8 max-w-2xl font-heading text-5xl font-bold leading-[1.08] text-[#07164b] sm:text-6xl">
