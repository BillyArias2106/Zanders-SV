...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "company_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"commercial_name" varchar DEFAULT 'Zanders SV' NOT NULL,
  	"legal_name" varchar,
  	"slogan" varchar DEFAULT 'Ideas que toman forma. Tecnología que despega.',
  	"short_description" varchar DEFAULT 'Fabricación, personalización, impresión profesional y soluciones aéreas con drones.',
  	"long_description" varchar,
  	"main_email" varchar,
  	"main_phone" varchar DEFAULT '+503 7934 7603',
  	"whatsapp" varchar DEFAULT '+503 7934 7603',
  	"address" varchar,
  	"country_city" varchar DEFAULT 'El Salvador',
  	"business_hours" varchar,
  	...
  	"contact_headline" varchar DEFAULT '¡Trabajemos en una nueva visión de tu negocio!',
  	"contact_intro" varchar,
  	"default_meta_title" varchar DEFAULT 'Zanders SV | Aero Solutions' NOT NULL,
  	"default_meta_description" varchar DEFAULT 'Plataforma digital para Zanders SV y Zanders Aero Solutions: fabricación, personalización y soluciones aéreas con drones.' NOT NULL,
  	"global_keywords" varchar,
  	"canonical_base_url" varchar DEFAULT 'http://localhost:3000',
  	"copyright_text" varchar DEFAULT '© Zanders SV. Todos los derechos reservados.',
